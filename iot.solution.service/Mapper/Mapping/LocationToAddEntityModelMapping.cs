...
{
    public class LocationToAddEntityModelMapping : ITypeConverter<Entity.AddLocationRequest, IOT.AddEntityModel>
    {
        public IOT.AddEntityModel Convert(Entity.AddLocationRequest source, IOT.AddEntityModel destination, ResolutionContext context)
        {
            if (source == null)
            {
                return null;

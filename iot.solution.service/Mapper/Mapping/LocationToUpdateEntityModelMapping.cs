...
{
    public class LocationToUpdateEntityModelMapping : ITypeConverter<Entity.AddLocationRequest, IOT.UpdateEntityModel>
    {
        public IOT.UpdateEntityModel Convert(Entity.AddLocationRequest source, IOT.UpdateEntityModel destination, ResolutionContext context)
        {
            if (source == null)
            {
                return null;

...
import {
	RolesListComponent, RolesAddComponent, MessageDialogComponent,
	...
	HeaderComponent, LoginHeaderComponent, LoginFooterComponent, LeftMenuComponent, LoginComponent, AlertsComponent,
	PageSizeRenderComponent, PaginationRenderComponent, ResetpasswordComponent,
	SearchRenderComponent, SettingsComponent, MyProfileComponent, ChangePasswordComponent, SubscribersListComponent, HardwareListComponent, HardwareAddComponent, UserAdminListComponent, AdminUserAddComponent, SubscriberDetailComponent, GeneratorListComponent, LocationAddComponent, GeneratorAddComponent
...
import { LocationListComponent } from './components/dashboard/location-list/location-list.component'
...
@NgModule({
	...
	imports: [
		...
		AgmCoreModule.forRoot({ apiKey: '[YOUR GOOGLE API KEY]' }),

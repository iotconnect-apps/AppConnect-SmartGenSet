		...
		BEGIN TRAN
			...
			BEGIN
				;WITH
					...
					(
						SELECT [guid]
						FROM dbo.[Location] d (NOLOCK)
					)

				INSERT INTO dbo.[Location] ([guid], [name], [address], [city], [stateGuid], [countryGuid], [companyGuid], [isDeleted],[createdDate])

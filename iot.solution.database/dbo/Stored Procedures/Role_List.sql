...
BEGIN
    ...
    BEGIN TRY            
		...
		DECLARE @gensetGuid UNIQUEIDENTIFIER 

		SELECT @gensetGuid = [gensetGuid] 
		FROM [dbo].[User] (NOLOCK) 
		WHERE companyguid = @companyguid 
		AND [guid] = @invokinguser
		AND [isdeleted]=0

		IF ISNULL(@gensetGuid, '00000000-0000-0000-0000-000000000000') = '00000000-0000-0000-0000-000000000000' BEGIN
			Set @output = -3
		...
		EXEC sp_executesql
			  @Sql
			, N'@orderby nvarchar(100), @companyguid UNIQUEIDENTIFIER, @invokinguser UNIQUEIDENTIFIER, @gensetGuid UNIQUEIDENTIFIER'
			, @orderby			= @orderby			

...
001	sgh-1 06-12-2019 [Nishit Khakhi]	Added Initial Version to Delete Generator
*******************************************************************/
CREATE PROCEDURE [dbo].[Generator_Delete]
...
BEGIN
	...
	BEGIN
        ...
        SELECT @Param = 
        (
            SELECT 'Generator_Delete' AS '@procName'             

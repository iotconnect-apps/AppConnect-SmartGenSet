...
001	SGH-1 05-12-2019 [Nishit Khakhi]	Added Initial Version to Update Generator Image
*******************************************************************/

create PROCEDURE [dbo].[Generator_UpdateImage]
(
...
BEGIN
	...
	BEGIN
        ...
        SELECT @Param =
        (
            SELECT 'Generator_UpdateImage' AS '@procName'

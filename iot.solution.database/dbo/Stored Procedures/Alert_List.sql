   ...
   BEGIN TRY
		...
		SET @Sql = '	SELECT
						...
						(	SELECT
							...
							INNER JOIN dbo.[Generator] E WITH (NOLOCK) ON I.[deviceGuid] = E.[guid] AND E.[isDeleted] = 0
							JOIN dbo.[Location] G WITH (NOLOCK) ON I.[entityGuid] = G.[guid] AND G.[isDeleted] = 0
